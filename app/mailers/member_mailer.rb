class MemberMailer < ApplicationMailer
  ...
  def schedule_email(team, season)
    ...
    @events = team.events.where(season_id: season)
    @url = 'timetrak.herokuapp.com/calendar/view?team_name='+Base64.urlsafe_encode64(team_name)+'&season='+Base64.urlsafe_encode64(season.to_s)
